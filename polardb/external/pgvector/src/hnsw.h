...
/*
 * 【优化3.3】200维专用版本：SQ8 vs SQ8距离计算
 *
 * 针对竞赛环境（10M向量，200维）的专门优化：
 * - 200 = 12×16 + 8，完全展开循环
 * - 4个累加器提升ILP
 * - 用于索引构建时的距离计算
 */
__attribute__((target("avx512f,avx512bw,avx512vl,avx512dq,fma")))
static inline float
HnswSQ8Distance2_Vector_200dim(Vector *a, Vector *b)
{
    char *bufa = (char *) a->x;
    char *bufb = (char *) b->x;
    ...
    if (sa == 0.0f && sb == 0.0f) {
        float diff = ba - bb;
        return 200.0f * diff * diff;
    }

    const __m512 v_sa = _mm512_set1_ps(sa);
    const __m512 v_ba = _mm512_set1_ps(ba);
    const __m512 v_sb = _mm512_set1_ps(sb);
    const __m512 v_bb = _mm512_set1_ps(bb);
    ...
    /* 迭代 0-3 (维度 0-63) */
    {
        __m128i ua0 = _mm_loadu_si128((const __m128i *)(qa + 0));
        __m128i ua1 = _mm_loadu_si128((const __m128i *)(qa + 16));
        __m128i ua2 = _mm_loadu_si128((const __m128i *)(qa + 32));
        __m128i ua3 = _mm_loadu_si128((const __m128i *)(qa + 48));
        __m128i ub0 = _mm_loadu_si128((const __m128i *)(qb + 0));
        __m128i ub1 = _mm_loadu_si128((const __m128i *)(qb + 16));
        __m128i ub2 = _mm_loadu_si128((const __m128i *)(qb + 32));
        __m128i ub3 = _mm_loadu_si128((const __m128i *)(qb + 48));

        __m512 fa0 = _mm512_cvtepi32_ps(_mm512_cvtepu8_epi32(ua0));
        __m512 fa1 = _mm512_cvtepi32_ps(_mm512_cvtepu8_epi32(ua1));
        __m512 fa2 = _mm512_cvtepi32_ps(_mm512_cvtepu8_epi32(ua2));
        __m512 fa3 = _mm512_cvtepi32_ps(_mm512_cvtepu8_epi32(ua3));
        __m512 fb0 = _mm512_cvtepi32_ps(_mm512_cvtepu8_epi32(ub0));
        __m512 fb1 = _mm512_cvtepi32_ps(_mm512_cvtepu8_epi32(ub1));
        __m512 fb2 = _mm512_cvtepi32_ps(_mm512_cvtepu8_epi32(ub2));
        __m512 fb3 = _mm512_cvtepi32_ps(_mm512_cvtepu8_epi32(ub3));

        __m512 va0 = _mm512_fmadd_ps(fa0, v_sa, v_ba);
        __m512 va1 = _mm512_fmadd_ps(fa1, v_sa, v_ba);
        __m512 va2 = _mm512_fmadd_ps(fa2, v_sa, v_ba);
        __m512 va3 = _mm512_fmadd_ps(fa3, v_sa, v_ba);
        __m512 vb0 = _mm512_fmadd_ps(fb0, v_sb, v_bb);
        __m512 vb1 = _mm512_fmadd_ps(fb1, v_sb, v_bb);
        __m512 vb2 = _mm512_fmadd_ps(fb2, v_sb, v_bb);
        __m512 vb3 = _mm512_fmadd_ps(fb3, v_sb, v_bb);
    ...
    /* 迭代 4-7 (维度 64-127) */
    {
        __m128i ua0 = _mm_loadu_si128((const __m128i *)(qa + 64));
        __m128i ua1 = _mm_loadu_si128((const __m128i *)(qa + 80));
        __m128i ua2 = _mm_loadu_si128((const __m128i *)(qa + 96));
        __m128i ua3 = _mm_loadu_si128((const __m128i *)(qa + 112));
        __m128i ub0 = _mm_loadu_si128((const __m128i *)(qb + 64));
        __m128i ub1 = _mm_loadu_si128((const __m128i *)(qb + 80));
        __m128i ub2 = _mm_loadu_si128((const __m128i *)(qb + 96));
        __m128i ub3 = _mm_loadu_si128((const __m128i *)(qb + 112));
    ...
    /* 迭代 8-11 (维度 128-191) */
    {
        __m128i ua0 = _mm_loadu_si128((const __m128i *)(qa + 128));
        __m128i ua1 = _mm_loadu_si128((const __m128i *)(qa + 144));
        __m128i ua2 = _mm_loadu_si128((const __m128i *)(qa + 160));
        __m128i ua3 = _mm_loadu_si128((const __m128i *)(qa + 176));
        __m128i ub0 = _mm_loadu_si128((const __m128i *)(qb + 128));
        __m128i ub1 = _mm_loadu_si128((const __m128i *)(qb + 144));
        __m128i ub2 = _mm_loadu_si128((const __m128i *)(qb + 160));
        __m128i ub3 = _mm_loadu_si128((const __m128i *)(qb + 176));
    ...
    /* 尾部8维 (维度 192-199): 使用掩码 */
    {
        __mmask16 tail_mask = 0x00FF;

        __m128i ua = _mm_maskz_loadu_epi8(tail_mask, (const void *)(qa + 192));
        __m128i ub = _mm_maskz_loadu_epi8(tail_mask, (const void *)(qb + 192));
        ...
        sum0 = _mm512_add_ps(sum0, _mm512_maskz_mov_ps(tail_mask, sq));
    }
    ...
    return hnsw_reduce_add_ps(sum0);
}
 ...
 * 保持原有签名和返回语义，根据维度自动选择最优实现
 */
static inline float
HnswSQ8Distance2_Vector(Vector *a, Vector *b)
{
    /* [优化3.3] 200维专用快速路径 - 竞赛数据集优化 */
    if (__builtin_expect(a->dim == 200, 1))
        return HnswSQ8Distance2_Vector_200dim(a, b);
...
/*
 * 【优化3.3】200维专用版本：SQ8 vs halfvec距离计算
 *
 * 针对竞赛环境（10M向量，200维，halfvec）的专门优化：
 * - 200 = 12×16 + 8，完全展开循环消除分支预测和循环开销
 * - 使用4个累加器提升ILP（指令级并行）
 * - 激进的寄存器使用减少内存访问
 * - 消除循环变量和边界检查
 */
__attribute__((target("avx512f,avx512bw,avx512vl,avx512dq,fma")))
static inline float
HnswSQ8HalfvecDistance2_200dim(const Vector *sq8, const HalfVector *hv)
{
    /* 直接访问数据指针，避免重复计算 */
    const char *buf = (const char *)sq8->x;
    ...
    if (__builtin_expect(s == 0.0f, 0))
    {
        ...
        /* 展开12次迭代（192维） */
        #define CONST_ITER(i) do { \
            __m256i h = _mm256_loadu_si256((const __m256i *)(hx + (i)*16)); \
            __m512 v = _mm512_cvtph_ps(h); \
            __m512 d = _mm512_sub_ps(v, v_bias); \
            sum##((i)%4) = _mm512_fmadd_ps(d, d, sum##((i)%4)); \
        } while(0)

        /* 手动展开以最大化并行 */
        __m256i h0 = _mm256_loadu_si256((const __m256i *)(hx + 0));
        __m256i h1 = _mm256_loadu_si256((const __m256i *)(hx + 16));
        __m256i h2 = _mm256_loadu_si256((const __m256i *)(hx + 32));
        __m256i h3 = _mm256_loadu_si256((const __m256i *)(hx + 48));
        ...
        __m512 d0 = _mm512_sub_ps(v0, v_bias);
        __m512 d1 = _mm512_sub_ps(v1, v_bias);
        __m512 d2 = _mm512_sub_ps(v2, v_bias);
        __m512 d3 = _mm512_sub_ps(v3, v_bias);
        ...
        /* 迭代 4-7 */
        h0 = _mm256_loadu_si256((const __m256i *)(hx + 64));
        h1 = _mm256_loadu_si256((const __m256i *)(hx + 80));
        h2 = _mm256_loadu_si256((const __m256i *)(hx + 96));
        h3 = _mm256_loadu_si256((const __m256i *)(hx + 112));

        v0 = _mm512_cvtph_ps(h0);
        v1 = _mm512_cvtph_ps(h1);
        v2 = _mm512_cvtph_ps(h2);
        v3 = _mm512_cvtph_ps(h3);

        d0 = _mm512_sub_ps(v0, v_bias);
        d1 = _mm512_sub_ps(v1, v_bias);
        d2 = _mm512_sub_ps(v2, v_bias);
        d3 = _mm512_sub_ps(v3, v_bias);
        ...
        /* 迭代 8-11 */
        h0 = _mm256_loadu_si256((const __m256i *)(hx + 128));
        h1 = _mm256_loadu_si256((const __m256i *)(hx + 144));
        h2 = _mm256_loadu_si256((const __m256i *)(hx + 160));
        h3 = _mm256_loadu_si256((const __m256i *)(hx + 176));
        ...
        /* 尾部8维：使用掩码 */
        __mmask16 tail_mask = 0x00FF; /* 低8位 */
        __m256i h_tail = _mm256_maskz_loadu_epi16(tail_mask, (const void *)(hx + 192));
        __m512 v_tail = _mm512_cvtph_ps(h_tail);
        __m512 d_tail = _mm512_sub_ps(v_tail, v_bias);
        __m512 sq_tail = _mm512_mul_ps(d_tail, d_tail);
        sum0 = _mm512_add_ps(sum0, _mm512_maskz_mov_ps(tail_mask, sq_tail));
        ...
        return hsum512_ps(sum0);

        #undef CONST_ITER
    }

    /* 一般情况：SQ8解码 + halfvec转float */
    const __m512 v_scale = _mm512_set1_ps(s);
    const __m512 v_bias = _mm512_set1_ps(b);
    ...
    /* 迭代 0-3 (维度 0-63) */
    {
        __m128i u0 = _mm_loadu_si128((const __m128i *)(q + 0));
        __m128i u1 = _mm_loadu_si128((const __m128i *)(q + 16));
        __m128i u2 = _mm_loadu_si128((const __m128i *)(q + 32));
        __m128i u3 = _mm_loadu_si128((const __m128i *)(q + 48));
        ...
        __m512 fq0 = _mm512_cvtepi32_ps(_mm512_cvtepu8_epi32(u0));
        __m512 fq1 = _mm512_cvtepi32_ps(_mm512_cvtepu8_epi32(u1));
        __m512 fq2 = _mm512_cvtepi32_ps(_mm512_cvtepu8_epi32(u2));
        __m512 fq3 = _mm512_cvtepi32_ps(_mm512_cvtepu8_epi32(u3));

        __m512 rec0 = _mm512_fmadd_ps(fq0, v_scale, v_bias);
        __m512 rec1 = _mm512_fmadd_ps(fq1, v_scale, v_bias);
        __m512 rec2 = _mm512_fmadd_ps(fq2, v_scale, v_bias);
        __m512 rec3 = _mm512_fmadd_ps(fq3, v_scale, v_bias);

        __m512 vh0 = _mm512_cvtph_ps(h0);
        __m512 vh1 = _mm512_cvtph_ps(h1);
        __m512 vh2 = _mm512_cvtph_ps(h2);
        __m512 vh3 = _mm512_cvtph_ps(h3);

        __m512 d0 = _mm512_sub_ps(vh0, rec0);
        __m512 d1 = _mm512_sub_ps(vh1, rec1);
        __m512 d2 = _mm512_sub_ps(vh2, rec2);
        __m512 d3 = _mm512_sub_ps(vh3, rec3);
    ...
    /* 迭代 4-7 (维度 64-127) */
    {
        __m128i u0 = _mm_loadu_si128((const __m128i *)(q + 64));
        __m128i u1 = _mm_loadu_si128((const __m128i *)(q + 80));
        __m128i u2 = _mm_loadu_si128((const __m128i *)(q + 96));
        __m128i u3 = _mm_loadu_si128((const __m128i *)(q + 112));

        __m256i h0 = _mm256_loadu_si256((const __m256i *)(hx + 64));
        __m256i h1 = _mm256_loadu_si256((const __m256i *)(hx + 80));
        __m256i h2 = _mm256_loadu_si256((const __m256i *)(hx + 96));
        __m256i h3 = _mm256_loadu_si256((const __m256i *)(hx + 112));
    ...
    /* 迭代 8-11 (维度 128-191) */
    {
        __m128i u0 = _mm_loadu_si128((const __m128i *)(q + 128));
        __m128i u1 = _mm_loadu_si128((const __m128i *)(q + 144));
        __m128i u2 = _mm_loadu_si128((const __m128i *)(q + 160));
        __m128i u3 = _mm_loadu_si128((const __m128i *)(q + 176));

        __m256i h0 = _mm256_loadu_si256((const __m256i *)(hx + 128));
        __m256i h1 = _mm256_loadu_si256((const __m256i *)(hx + 144));
        __m256i h2 = _mm256_loadu_si256((const __m256i *)(hx + 160));
        __m256i h3 = _mm256_loadu_si256((const __m256i *)(hx + 176));
    ...
    /* 尾部8维 (维度 192-199): 使用掩码 */
    {
        __mmask16 tail_mask = 0x00FF; /* 低8位有效 */

        __m128i u_tail = _mm_maskz_loadu_epi8(tail_mask, (const void *)(q + 192));
        __m256i h_tail = _mm256_maskz_loadu_epi16(tail_mask, (const void *)(hx + 192));

        __m512 fq_tail = _mm512_cvtepi32_ps(_mm512_cvtepu8_epi32(u_tail));
        __m512 rec_tail = _mm512_fmadd_ps(fq_tail, v_scale, v_bias);

        __m512 vh_tail = _mm512_cvtph_ps(h_tail);
        __m512 d_tail = _mm512_sub_ps(vh_tail, rec_tail);
        __m512 sq_tail = _mm512_mul_ps(d_tail, d_tail);
...
HnswSQ8HalfvecDistance2(Vector *sq8, HalfVector *hv)
{
    ...
    /* [优化3.3] 200维专用快速路径 - 竞赛数据集优化 */
    if (__builtin_expect(sq8->dim == 200, 1))
        return HnswSQ8HalfvecDistance2_200dim(sq8, hv);
